...
theme.set_highlights = function()
	...
	hl(0, "Search", { fg = c.none, bg = u.darken(c.Search, 0.5) })
	...
	-- Treesitter
	hl(0, "@error", { fg = c.vscRed, bg = c.none })
	hl(0, "@punctuation.bracket", { fg = c.vscFront, bg = c.none })
	hl(0, "@punctuation.special", { fg = c.vscFront, bg = c.none })
	hl(0, "@punctuation.special.markdown", { fg = c.Blue, bold = true })
	hl(0, "@comment", { fg = c.vscGreen, bg = c.none })
	hl(0, "@constant", { fg = c.vscYellow, bg = c.none })
	hl(0, "@constant.builtin", { fg = c.vscBlue, bg = c.none })
	hl(0, "@constant.macro", { fg = c.vscBlueGreen, bg = c.none })
	hl(0, "@string.regex", { fg = c.vscOrange, bg = c.none })
	hl(0, "@string", { fg = c.vscOrange, bg = c.none })
	hl(0, "@character", { fg = c.vscOrange, bg = c.none })
	hl(0, "@number", { fg = c.vscLightGreen, bg = c.none })
	hl(0, "@boolean", { fg = c.vscBlue, bg = c.none })
	hl(0, "@float", { fg = c.vscLightGreen, bg = c.none })
	hl(0, "@annotation", { fg = c.vscYellow, bg = c.none })
	hl(0, "@attribute", { fg = c.vscBlueGreen, bg = c.none })
	hl(0, "@namespace", { fg = c.vscBlueGreen, bg = c.none })
	hl(0, "@function.builtin", { fg = c.vscYellow, bg = c.none })
	hl(0, "@function", { fg = c.vscYellow, bg = c.none })
	hl(0, "@function.macro", { fg = c.vscYellow, bg = c.none })
	hl(0, "@parameter", { fg = c.vscLightBlue, bg = c.none })
	hl(0, "@parameter.reference", { fg = c.vscLightBlue, bg = c.none })
	hl(0, "@method", { fg = c.vscYellow, bg = c.none })
	hl(0, "@field", { fg = c.vscLightBlue, bg = c.none })
	hl(0, "@property", { fg = c.vscLightBlue, bg = c.none })
	hl(0, "@constructor", { fg = c.vscBlueGreen, bg = c.none })
	hl(0, "@conditional", { fg = c.vscPink, bg = c.none })
	hl(0, "@repeat", { fg = c.vscPink, bg = c.none })
	hl(0, "@label", { fg = c.vscLightBlue, bg = c.none })
	hl(0, "@keyword", { fg = c.vscPink, bg = c.none })
	hl(0, "@keyword.function", { fg = c.vscBlue, bg = c.none })
	hl(0, "@keyword.operator", { fg = c.vscBlue, bg = c.none })
	hl(0, "@operator", { fg = c.vscFront, bg = c.none })
	hl(0, "@exception", { fg = c.vscPink, bg = c.none })
	hl(0, "@type", { fg = c.vscBlueGreen, bg = c.none })
	hl(0, "@type.builtin", { fg = c.vscBlue, bg = c.none })
	hl(0, "@type.qualifier", { fg = c.vscBlue, bg = c.none })
	hl(0, "@storageClass", { fg = c.vscBlue, bg = c.none })
	hl(0, "@structure", { fg = c.vscLightBlue, bg = c.none })
	hl(0, "@include", { fg = c.vscPink, bg = c.none })
	hl(0, "@variable", { fg = c.vscLightBlue, bg = c.none })
	hl(0, "@variable.builtin", { fg = c.vscLightBlue, bg = c.none })
	hl(0, "@text", { fg = c.vscFront, bg = c.none })
	hl(0, "@text.underline", { fg = c.vscYellowOrange, bg = c.none })
	hl(0, "@tag", { fg = c.vscBlue, bg = c.none })
	hl(0, "@tag.delimiter", { fg = c.vscGray, bg = c.none })
	hl(0, "@tag.attribute", { fg = c.vscLightBlue, bg = c.none })

	hl(0, "@text.title", { fg = c.vscBlue, bold = true })
	hl(0, "@text.literal", { fg = c.vscFront, bg = c.none })
	hl(0, "markdown@text.literal", { fg = c.vscOrange, bg = c.none })
	hl(0, "markdown_inline@text.literal", { fg = c.vscOrange, bg = c.none })
	hl(0, "@text.emphasis", { fg = c.vscFront, bg = c.none, italic = true })
	hl(0, "@text.strong", { fg = c.vscBlue, bold = true })
	hl(0, "@text.uri", { fg = c.vscFront, bg = c.none })
	hl(0, "@textReference", { fg = c.vscOrange })
	hl(0, "@punctuation.delimiter", { fg = c.vscFront, bg = c.none })
	hl(0, "@stringEscape", { fg = c.vscOrange, bold = true })

	hl(0, "@text.note", { fg = c.vscBlueGreen, bg = c.none, bold = true })
	hl(0, "@text.warning", { fg = c.vscYellowOrange, bg = c.none, bold = true })
	hl(0, "@text.danger", { fg = c.vscRed, bg = c.none, bold = true })
