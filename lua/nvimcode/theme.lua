...
theme.set_highlights = function()
    ...
    hl(0, 'ColorColumn', { fg = c.none, bg = c.CursorDarkDark })
    ...
    hl(0, 'Search', { fg = c.None, bg = u.darken(c.SearchY, 0.5) })
    ...
    hl(0, 'TabLineSep', {fg=c.TabCurrent, bg=c.TabOutside})
    hl(0, 'TabLineSepIn', {fg=c.TabOutside, bg=c.TabOutside})
    ...
    -- Nvim compe
		...
		hl(0, 'CmpDocBorder', { fg = "#1b1f27", bg = c.none })
